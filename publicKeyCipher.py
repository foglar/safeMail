...
def main():
    ...
    mode = str(input("Do you wish to encrypt or decrypt a file? ").lower())

    if mode.startswith("e") == True:
        message = input("Enter your message: ")
        pubKeyFilename = "foglar_pubkey.txt"
        ...
        print(encryptedText)
    elif mode.startswith("d") == True:
        privKeyFilename = "foglar_privkey.txt"
